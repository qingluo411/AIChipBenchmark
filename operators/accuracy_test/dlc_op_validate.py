...
if __name__ == "__main__":
    ...
    if case and case != 'CONV':
        tester = DLCOpValidater(config[case], case, gt_path)
        tester.run_all()
        exit(0)
    # test all op
    else:
